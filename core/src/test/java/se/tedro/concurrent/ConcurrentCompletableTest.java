...
public class ConcurrentCompletableTest {
  ...
  /**
   * verify alias of #{link {@link se.tedro.concurrent.ConcurrentCompletable#complete(Object)}}
   */
  @Test
   ...
   * {@link se.tedro.concurrent.ConcurrentCompletable#fail(java.lang.Throwable)}}
   */
  @Test
  ...
  /**
   * verify alias of #{link {@link se.tedro.concurrent.ConcurrentCompletable#cancel()}}
   */
  @Test
