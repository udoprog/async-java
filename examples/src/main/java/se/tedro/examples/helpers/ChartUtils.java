...
public class ChartUtils {
  ...
  private static final List<Color> COLORS =
    ImmutableList.of(Color.RED, Color.PINK, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.MAGENTA,
      Color.CYAN, Color.BLUE, Color.WHITE, Color.BLACK);
  ...
  private static JFreeChart createChart(
    String title, String xAxis, String yAxis1, XYDataset dataset1, String yAxis2, XYDataset dataset2
  ) {
    JFreeChart chart =
      ChartFactory.createXYLineChart(title, xAxis, yAxis1, dataset1, PlotOrientation.VERTICAL, true,
        true, false);
  ...
  public static void showChart(
    String name, String xAxis, String yAxis1, XYDataset dataset1, String yAxis2, XYDataset dataset2
  ) {
